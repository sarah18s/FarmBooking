...
namespace FarmBookingBackend.Infrastructure.Migrations
{
    ...
    [Migration("20240924193701_edit2")]
    partial class edit2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmBookingBackend.Domain.Entities.Farm", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 380, DateTimeKind.Local).AddTicks(9979),
                        ...
                        {
                            Id = 2,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(11),
                            Description = "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        {
                            Id = 3,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(15),
                            Description = "Fusce 11 tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
            ...
            modelBuilder.Entity("FarmBookingBackend.Domain.Entities.FarmRoom", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FarmRoom_Number = 101,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(78),
                            FarmId = 1,
                        ...
                        {
                            FarmRoom_Number = 102,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(84),
                            FarmId = 1,
                        ...
                        {
                            FarmRoom_Number = 103,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(86),
                            FarmId = 1,
                            SpecialDetails = "has 3 bed"
                        },
                        new
                        {
                            FarmRoom_Number = 104,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(89),
                            FarmId = 1,
                        ...
                        {
                            FarmRoom_Number = 201,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(91),
                            FarmId = 2,
                            SpecialDetails = "Master bedroom"
                        },
                        new
                        {
                            FarmRoom_Number = 202,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(93),
                            FarmId = 2,
                            SpecialDetails = "has 2 bed"
                        },
                        new
                        {
                            FarmRoom_Number = 203,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(96),
                            FarmId = 2,
                            SpecialDetails = "has 2 bed"
                        },
                        new
                        {
                            FarmRoom_Number = 301,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(98),
                            FarmId = 3,
                            SpecialDetails = "Master bedroom"
                        },
                        new
                        {
                            FarmRoom_Number = 302,
                            Created_Date = new DateTime(2024, 9, 24, 22, 37, 0, 381, DateTimeKind.Local).AddTicks(100),
                            FarmId = 3,
                            SpecialDetails = "has 2 bed"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "870149f3-ba99-411b-8d6b-4261e17b1701",
                            Name = "customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "b36a364a-9288-4be6-b027-a9578056cfa1",
                            Name = "admin",
